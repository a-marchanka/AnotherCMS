 ...
 *
*/
function zipAddFile($data, $name, $time = 0) {
	$datasec = array();
	$ctrl_dir = array();
	$old_offset = 0;
	...
	$dtime	= substr( "00000000" . dechex(unix2DosTime($time)), -8);
	...
	pack('V', strlen($data)) . "\x00\x00";  // offset to start of central dir // .zip file comment length
}
?>
