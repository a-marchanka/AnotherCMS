...
if ($subaction == 'search') {
	...
	profileUpdate(DB_PREFIX, $db_link, $auth_id, 'ord_sort', $search_s);
} else {
	if (isset($cfg_profile['ord_sort'])) $search_s = $cfg_profile['ord_sort'];
...
// count rows
$items_total = orderGetCount(DB_PREFIX, $db_link, $search_var);
...
// set search options
$out_var = orderGetList(DB_PREFIX, $db_link, $search_var, $pager_var);
//print_r($out_var);
