...
if ($subaction == 'search') {
	...
	profileUpdate(DB_PREFIX, $db_link, $auth_id, 'pay_sort', $search_s);
} else {
	if (isset($cfg_profile['pay_sort'])) $search_s = $cfg_profile['pay_sort'];
...
// count rows
$items_total = paymentGetCount(DB_PREFIX, $db_link, $search_var);
...
// set search options
$out_var = paymentGetAll(DB_PREFIX, $db_link, $search_var, $pager_var, $format_dec_point, $format_ths_sep);
//print_r($out_var);
