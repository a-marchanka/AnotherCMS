...
if ($subaction == 'search') {
	...
	profileUpdate(DB_PREFIX, $db_link, $auth_id, 'prd_sort', $search_s);
} else {
	if (isset($cfg_profile['prd_sort'])) $search_s = $cfg_profile['prd_sort'];
...
// count rows
$items_total = productGetCount(DB_PREFIX, $db_link, $search_var);
...
// set search options
$out_var = productGetAll(DB_PREFIX, $db_link, $search_var, $pager_var, $format_dec_point, $format_ths_sep);
//print_r($out_var);
