...
document.forms['form_details'].elements['subaction'].value = 'dir_close';
...
<div class="w3-half">
<label>{#LB_folder#} <span class="w3-text-red">*</span>: <b>/{$details.dir}</b></label>
...
<input name="attr" id="attr" type="text" value="{$details.attr|default:"0755"}" size="4" maxlength="4" class="w3-input w3-border w3-round w3-margin-bottom-8" style="max-width:100px;" required>
</div>
...
<input name="subaction" id="subaction" type="hidden" value="dir">
