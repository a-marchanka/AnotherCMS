...
function Lytebox(bInitialize, aHttp) {
	...
	/*** Configure HTML Content / Media Viewer Options ***/
		...
		this.__width			= '95%';		// default width of content viewer
	...
	/*** Configure Slideshow Options ***/
		...
		this.__slideInterval		= 3000;			// change value (milliseconds) to increase/decrease the time between "slides"
...
Lytebox.prototype.loadContent = function() {
	try {
		...
		if (this.inline || (uri.match(/.mov|.mp4|.mpg|.webm|.wav|.mp3|.m4a/i))) {
			iframe.src = 'about:blank';
			this.frameSource = '';
...
Lytebox.prototype.buildObject = function(w, h, url) {
	...
	var type = url.match(/.mov|.mp4|.mpg|.webm|.wav|.mp3|.m4a/i);
	switch(type[0]) {
		case '.mov':
		case '.mp4':
		case '.mpg':
			object 	= '<video style="width:' + w + 'px; height:' + h + 'px;" controls>'
		...
		case '.mp3':
		case '.m4a':
			object 	= '<audio style="width:' + w + 'px; height:' + h + 'px;" controls>'
