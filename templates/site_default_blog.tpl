...
<link rel="stylesheet" href="images/w3-font-raleway.css">
...
<body onload="rMsg();" class="w3-light-grey" style="margin:auto;">
{include file=$pattern_menu_main|default:"menu_empty.tpl"}
<!-- !PAGE CONTENT! -->
<div class="w3-main w3-padding" style="margin-left:290px;max-width:1100px;min-width:360px;">
